...
const Bannersection = () => {
  return (
    <section className="blue-bird-logistics-section bg-no-repeat relative w-full overflow-hidden py-[134px]" 
    style={{backgroundImage: `url(${bannerbgimage.src})`}}>
      <div className="z-10 mx-auto container px-4 ">
          ...
          <div className="flex justify-center lg:col-span-6 xl:col-span-5 lg:justify-end">
            <div className=" ">
              <Image
                ...
                alt=""
                className="h-auto w-full object-contain object-bottom drop-shadow-2xl absolute bottom-0 right-0 max-w-[891px]"
